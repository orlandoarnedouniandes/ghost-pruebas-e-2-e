...
context("UpdatePost",function () {
    ...
    it("Dinamico - El usuario editor quiere cambiar el título de un post que había publicado anteriormente",function () {
        ...
        cy.get('@postTitle').then((title) => {
            ...
            //When the user updates the title and content with a dynamic value
